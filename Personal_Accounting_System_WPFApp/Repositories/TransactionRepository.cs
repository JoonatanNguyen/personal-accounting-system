    ...
    class TransactionRepository
    {
        public void AddTransaction(TransactionDto transaction)
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("INSERT INTO Transactions (Amount, Date, ProductName, Explanation, PayerAccount, ReceiverAccount, OwnerOfPurchase, CategoryId) VALUES (@amount, @date, @product, @explain, @payer, @receiver, @owner, @category)", conn);
